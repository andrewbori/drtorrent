    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            if (infoHash.equals("Correct")) {
                out.println("d8:intervali1800e8:completei23e10:incompletei7e10:tracker id8:abc12efg5:peersld7:peer id20:abcdefghijklmnopqrst2:ip13:192.168.0.1004:porti6881eed7:peer id20:zyxwvutsrqponmlkjihi2:ip15:192.168.100.1284:porti6882eed7:peer id20:abc123efg456ijk7890z2:ip7:0.0.0.04:porti6883eeee");
                ...
                out.println(str);
            } else if (infoHash.equals("Empty")) {
            } else if (infoHash.equals("WrongContent")) {
                out.println("ld7:peer id20:abcdefghijklmnopqrst2:ip13:192.168.0.1004:porti6881eed7:peer id20:zyxwvutsrqponmlkjihi2:ip15:192.168.100.1284:porti6882eed7:peer id20:abc123efg456ijk7890z2:ip7:0.0.0.04:porti6883eee");
            }  else if (infoHash.equals("Failure")) {
                out.print("d14:failure reason19:info hash not founde");
            } else {
                out.print("d14:failure reason19:info hash not founde");
            }
